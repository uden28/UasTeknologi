...
<div class="container">
  <div align="center">
    ...
    <h4><p align="center"><a href="index.html">DEKSTOP WEB SMK</a></p></h4>
    <h5><b>Data Siswa SMK 1 SerbaBebas</b></h5>
  </div>
          ...
          <form class="form-inline" >
            <div class="form-group">
              <select class="form-control" id="Kolom" name="Kolom" required="">
                ...
                ?>
                <option value="Nama Siswa" <?php if ($kolom=="Nama Siswa") echo "selected"; ?>>Nama Siswa</option>
